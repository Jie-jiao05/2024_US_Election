...
The remainder of this paper is structured as follows. @sec-data we will discuss the data used in the modelling process and the result of the Bayesian Spline fit with its predictor variables and the response after transformation. @sec-dis the shortcomings of the study and areas for improvement will be described. @sec-Appendix-A A Deep Dive to a pollster will be conducted, and @sec-Appendix-B We will given a idealized survey and methodology
...
plot2 <- pp_check(rep_spline_model) +
  ...
  labs(
    ...
    subtitle = "Fatter tail above 50 suggests higher chance of upward surprises",
    x = "Predicted Outcome",
    y = "Density"
  ) +
  theme(legend.position = "bottom")
