...
We use the statistical programming language R [@citeR] to analysis the data which are extracted from the 2024 U.S. General President Election collected and published by FiveThirtyEight  [@FiveThirtyEight]. This paper will conduct a Multiple Linear Regression to do further prediction. In this model, we take numeric_grade, pollscore, sample_size as predictors, and pct as response. 
